...
![ivr_256p.png](/minipbx/icons/ivr_256p.png =75%x){.align-left} | IVR меню | Голосовое приветствие с возможностью донабора короткого номера для выполнения сценария, позволяет набрать прямой внутреннии номер и перевести вызов сразу на нужного абонента
![ivr_back.png](/minipbx/icons/ivr_back.png =75%x){.align-left} | Возврат в IVR меню | Позволяет вернуть абонента в начало IVR меню
![label.png](/minipbx/icons/label.png =60%x){.align-left} | Метка | Точка в сценарии, на которую можно в любой момент вернуться
...
![email.png](/minipbx/icons/email.png) | [Отправить E-mail](./modules/send_email) | Отправить уведомление по E-mail
![sms.png](/minipbx/icons/sms.png) | Отправить SMS | Отправка уведомление о звонке через модем
![telegram.png](/minipbx/icons/telegram.png) | [Отправить уведомление в Telegram](./modules/send_telegram) | Отправка оповещения о звонке через Telegram
